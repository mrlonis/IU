...
/**
 * This Class is an implementation of the List<T> interface. This class works on any and all primitive
 * data type and contains the void add(T x); T remove(int i); T get(int i); boolean contains(T x);
 * int size(); and boolean isEmpty(); methods from List<T>.
 *
...
public class SinglyLinkedList<T> implements List<T> {
	...
	/**
	 * This class represents a node in a linked-list. The node contains two data fields: 1. for data of type
	 * T and 2. Another Node variable called next which points to the next node in the linked-list.
	 */
	public class Node {
		/**
		...
		/**
		 * A Node constructor which constructs a Node with the given data and makes the next field equal to
	 ...
	 * @throws	IndexOutOfBoundsException	if the index is less than zero or if i is greater than or 
	...
	/**
	 * This method finds the value of the Node at index i in the linked-list and returns the value 
	 * of type T.
	 * 
	 * @param	i	The index Node to return the value of.
	 * @return		The data value of the Node at index i.
	 * @throws	IndexOutOfBoundsException	if i is less than zero or if i is greater than or equal to the
	 * 										size of the linked-list chain.
	 */
	public T get(int i) {
		if (i < 0 || i >= size())
			throw new IndexOutOfBoundsException();
	...
	/**
	 * This method returns <code>true</code> iff the data x is in one of the Nodes in the linked-list. 
	 * Returns <code>false</code> otherwise.
	 * 
	 * @param	x	The data that the method will check if exists in one of the Nodes in the linked-list.
	 * @return		<code>true</code> if x exists in one of the Nodes in the linked-list, otherwise 
	 * 				<code>false</code>.
	 */
	...
	/**
	 * This method returns <code>true</code> iff the size of the linked-list equals zero, otherwise it 
...
/**
 * This interface is of the type T and contains the methods void add(T x); T remove(int i); T get(int i); 
 * boolean contains(T x); int size(); and boolean isEmpty(); to be used in the SinglyLinkedList<T> Class.
 *
...
interface List<T> {
	 ...
	 * @return	<code>true</code> if the linked-list contains a Node with data equal to x, otherwise 
	 * 			<code>false</code>.
	 */

...
/**
 * MatchBot class that searches through a user's Tweets and finds Tweets
 * containing patterns. Employs the Naive, KMP, and Boyer-Moore algorithms from
 * StringMatch.java and extends TwitterBot.java.
 * 

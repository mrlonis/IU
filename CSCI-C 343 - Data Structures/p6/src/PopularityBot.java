...
/**
 * This class is provided as an example of how you might process the data
 * fetched from Twitter. Notice that we extend TwitterBot to set up the
 * connection.
 */
public class PopularityBot extends TwitterBot {
	...
	/**
	 * Takes the text of each status and splits it into individual lower-case
	 * words, trims the punctuation, and ignores any uninteresting words.
	 */
	private void split() {

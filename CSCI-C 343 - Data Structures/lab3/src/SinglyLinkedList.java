...
public class SinglyLinkedList<T> implements List<T> {
	...
	/**
	 * Node is a pair containing a data field and a pointer to the next node in
	 * the list.
	 */
	class Node {
		T data;
	...
	/**
	 * This method takes two indices and exchanges the data in the nodes at the
	 * given indices.
	 * 
	 * @throws IndexOutOfBoundsException
	 *             if either indices is out of range for the list.
	 */

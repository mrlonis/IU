...
public class SelfAdjustingList<T> extends DoublyLinkedList<T> {
	...
	/**
	 * Adds elements to the front of this list. Overrides the add method in the
	 * super class DoublyLinkedList<T>.
	 * 
	 * @param x
	...
	/**
	 * Finds the element at index i, returns it, and also moves it to the front
	 * of this list.
	 * 
	 * @param i

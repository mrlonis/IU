...
public class DoublyLinkedList<T> implements List<T> {
	 ...
	 * 
	 * @param x
	 *            The item being added to the end of this list.
	 */
	public void add(T x) {
		n++;
		Node last = head.prev;
	 ...
	 * 
	 * @param x
	 *            The item to be added to the front of this list.
	 */
	 ...
	 * 
	 * @param i
	 *            The index for the element to be removed.
	 ...
	 * 
	 * @param x
	 *            The item to search if this list contains.
	...
	public Iterator<T> iterator() {
		return new Iterator<T>() {
			...
			/**
			 * Returns the element in at the current node in the iterator and
	...
	public static void main(String... args) {
		...
		assert xsS.remove(0).equals("Matthew");
		assert xsS.remove(1).equals("Steven");
		assert 4 == xsS.size();

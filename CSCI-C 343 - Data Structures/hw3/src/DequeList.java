 ...
 * following operations are possible: push(x): Insert itemx on the front end of
 * the deque. pop(): Remove the front item from the deque and return it.
 * inject(x): Insert itemx on the rear end of the deque. eject(): Remove the
 * rear item from the deque and return it.
 * 
...
public class DequeList<T> implements Deque<T> {
	 ...
	 * 
	 * @param x
	 *            The item to search if this deque contains.

/**
 * Here is the List interface and SinglyLinkedList class from Lecture 3a. Do the
 * following:
 * 
 * (1) Add appropriate Javadoc style comments to all methods. 
 * (2) Implement the remove() method. 
 * (3) Implement the toString() method. 
 * (4) Turn List into a generic interface and SinglyLinkedList into a generic class so that the structure 
 * can be used to hold any type T of data.
...
/**
 * This Class is an implementation of the List<T> interface. This class works on
 * any and all primitive data type and contains the void add(T x); T remove(int
 * i); T get(int i); boolean contains(T x); int size(); and boolean isEmpty();
 * methods from List<T>.
 *
 * @param <T>
 *            The type for this generic class.
 */
public class SinglyLinkedList<E> implements List<E> {

	/**
	 * This class represents a node in a linked-list. The node contains two data
	 * fields: 1. for data of type T and 2. Another Node variable called next
	...
	public class Node {
		...
		/**
		 * A Node constructor which constructs a Node with the given data and
		 * makes the next field null.
		 * 
		 * @param data
		 *            The data for the Node being created.
		 */
		Node(E data) {
			this(data, null);
		}
		...
		/**
		 * A Node constructor which constructs a Node with the given data and
		 * makes the next field equal to the given Node pointer.
		 * 
		 * @param data
		 *            The data for the Node being created.
		 * @param next
	 ...
	 * 
	 * @param x
	 *            The data for the Node being added to the end of the
	 *            linked-list.
	 */
	public void add(E x) {
		this.n++;
	 ...
	 * 
	 * @param i
	 *            The index for the Node being removed.
	 * @return Returns the data of the Node that was removed from the
	 *         linked-list.
	 * @throws IndexOutOfBoundsException
	 *             if the index is less than zero or if i is greater than or
	...
	/**
	 * This method finds the value of the Node at index i in the linked-list and
	 * returns the value of type T.
	 * 
	 * @param i
	 *            The index Node to return the value of.
	 * @return The data value of the Node at index i.
	 * @throws IndexOutOfBoundsException
	 *             if i is less than zero or if i is greater than or equal to
	 *             the size of the linked-list chain.
	 */
	public E get(int i) {
		if (i < 0 || i >= size()) {
			throw new IndexOutOfBoundsException();
	...
	/**
	 * This method returns <code>true</code> iff the data x is in one of the
	 * Nodes in the linked-list. Returns <code>false</code> otherwise.
	 * 
	 * @param x
	 *            The data that the method will check if exists in one of the
	 *            Nodes in the linked-list.
	 * @return <code>true</code> if x exists in one of the Nodes in the
	 *         linked-list, otherwise <code>false</code>.
	 */
	...
	/**
	 * This method returns the size of the linked-list by returning the n
	 * variable in SinglyLinkedList<T>().
	 * 
	...
	/**
	 * This method returns <code>true</code> iff the size of the linked-list
	 * equals zero, otherwise it returns <code>false</code>.
	 * 
	 * @return <code>true</code> if the size of the linked-list equals zero,
...
/**
 * This interface is of the type T and contains the methods void add(T x); T
 * remove(int i); T get(int i); boolean contains(T x); int size(); and boolean
 * isEmpty(); to be used in the SinglyLinkedList<T> Class.
 *
 * @param <T>
 *            The type for this generic interface.
 */
interface List<E> {
	 ...
	 * 
	 * @param x
	 *            The data for the Node added to the end of this linked-list.
	 */
	void add(E x);
	 ...
	 * 
	 * @param i
	 *            The index Node to return the data of.
	 * @return The data of the Node at index i. Is of type T.
	 */
	E get(int i);

	/**
	 * This method will return <code>true</code> iff the linked-list contains x,
	 * <code>false</code> otherwise.
	 * 
	 * @param x
	 *            The data that a Node in the linked-list must contain.
	 * @return <code>true</code> if the linked-list contains a Node with data
	 *         equal to x, otherwise <code>false</code>.
	 */
	...
	/**
	 * This method will return <code>true</code> iff the linked-list is empty,
	 * otherwise <code>false</code>.
	 * 
	 * @return <code>true</code> if the linked-list is empty, otherwise
	 *         <code>false</code>.
	 */
	boolean isEmpty();
}

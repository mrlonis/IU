...
/**
 * The LinkedQueue<E> class which is implemented based of a SinglyLinkedList<E>
 * and implements the generic interface Queue<E>.
 *
 * @param <E>
 *            Any Element in Java.
 */
public class LinkedQueue<E> implements Queue<E> {
	 ...
	 * 
	 * @param x
	 *            The element being added to the end of the LinkedQueue<E>.
	 */
	 ...
	 *             if the SinglyLinkedList<E> in our LinkedQueue<E> is empty.
	 */
	public E dequeue() {
		if (this.lls.isEmpty()) {
	...
	/**
	 * Returns the element at the front of the LinkedQueue<E>. This does not
	 * change the LinkedQueue<E>.
	 * 
	...
	/**
	 * Returns the element at the back of the LinkedQueue<E>. This does not
	 * change the LinkedQueue<E>.
	 * 
	...
	/**
	 * Returns <code>true</code> if the size of the LinkedQueue<E> is equal to
	 * <code>0</code>, otherwise returns <code>false</code>.
	 * 
	 * @return Returns <code>true</code> if the size of the LinkedQueue<E> is
	 *         equal to <code>0</code>, otherwise returns <code>false</code>.
	 */
	...
	/**
	 * This method returns a String representation of the LinkedQueue<E> by
	 * simply calling the <code>toString()</code> method on the
	 * SinglyLinkedList<E> variable <code>lls</code>.
	 * 
	 ...
	 * 
	 * @param args
	 *            String args for the main method.
	 */
...
/**
 * This is our generic interface for a Queue<E>. Implements the following
 * abstract classes.
 *
 * @param <E>
 *            Can be any element.
...
interface Queue<E> {
	 ...
	 * 
	 * @param x
	 *            The element being added to the Queue<E>.
	 */
	void enqueue(E x);

	/**
	 * This element will retrieve and return the first element in the Queue<E>.
	 * It will also remove the first element in the Queue<E>.
	 * 
	...
	/**
	 * Retrieves and returns the first element in the Queue<E>. Does not change
	 * the Queue<E>.
	 * 
	 * @return The first element in the Queue<E>.
	 */
	...
	/**
	 * Retrieves and returns the element in the back of the Queue<E>. Does not
	 * change the Queue<E>.
	 * 
	...
	/**
	 * Returns <code>true</code> iff the size of the Queue<E> is 0,
	 * <code>false</code> otherwise.
	 * 
	 * @return <code>true</code> iff the size of the Queue<E> is 0,
	 *         <code>false</code> otherwise.
	 */
	boolean isEmpty();
}
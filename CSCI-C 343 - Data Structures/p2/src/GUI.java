...
public class GUI extends JFrame {
	...
	/**
	 * Updates the display to show the number of steps used by the player so
	 * far.
	 */
	...
	/**
	 * An inner class to represent the physical manifestation of a Tile on a
	 * game board. These are clickable objects, so we'll take advantage of the
	 * functionality already implemented by JButton.
	 */

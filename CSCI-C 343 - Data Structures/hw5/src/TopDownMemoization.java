...
class SubProblem {
	 ...
	 * 
	 * Compares hashCodes in order to determine if the objects are the same.
	 */
	@Override
	 ...
	 * 
	 * return ((this.pos * 31) + (this.cap * 31) * 31);
	 * 
	 * &
	 * 
	 * return (this.pos * 31) + (this.cap * 31);
	 * 
	 * &
	 * 
	 * return (this.cap * 31) + this.pos;
	 */
	@Override
	public int hashCode() {

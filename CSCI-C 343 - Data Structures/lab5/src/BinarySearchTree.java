...
public class BinarySearchTree implements Tree {
	 ...
	 * TODO
	 * 
	 * Removes the key from this tree. Must run in O(h) time, where h is the
	 * height of the tree.
	 */
	...
	/**
	 * Inserts the key into this tree. Runs in O(h) time, where h is the height
	 * of the tree.
	 */
	...
	public static void main(String... args) {
		...
		/**
		 * TODO: As a challenge, arrange things so that attempts to remove key
		 * that are not in the tree are simply ignored (and do no harm).
		 */
		for (int key : a)
			bst.insert(key);
		n = bst.size();

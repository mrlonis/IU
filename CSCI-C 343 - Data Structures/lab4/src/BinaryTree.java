...
public class BinaryTree implements Tree {
	...
	class Node {
		...
		/**
		 * This contains the Node pointers that will be the branches of a Node.
		 * Contains both a Left and Right possible branch.
		 */
		Node left, right;

		/**
		 * Node constructor that takes only a data field. Essentially makes a
		 * leaf.
		 * 
		 * @param key
		 ...
		 * @param left
		 *            The pointer to the left Node relative to this Node.
		 * @param right
		 *            The pointer to the right Node relative to this Node.
		 */
	...
	/**
	 * This inserts the key into a spot in the BinaryTree. If the root Node is
	 * null, it creates a new Node at the root. If the root.left Node is null it
	 * creates a new node there. If the root.right Node is null it creates a new
	 * Node there. Otherwise if none of those conditions work out, there's a 50%
	 * chance it makes a new Node as the root with the old root being on its
	 * left and a 50% chance of the old root being on the right.
	 * 
	 * @param key
	 *            The data for the Node that is to be inserted.
	 */
	 ...
	 * 
	 * @param key
	 *            The data we want to know if it exists in the tree.
	...
	/**
	 * Find the length of the longest root->leaf pathway. Uses recursion to
	 * check all branches.
	 * 
	 * @param node
	 *            The node the function is currently at.
	 * @return The length of the longest root->leaf pathway.
	 */

 ...
 * 
 * TODO: Complete the following task: Implement the ListGraph.hasCycle() method.
 */
interface Graph {
...
/**
 * ListGraph is a class that implements an undirected graph using a Map of
 * adjacency lists.
 * 
 * A graph has no self-loops and no parallel edges. We assume that vertices are
 * labeled by the integers 0, 1, ..., n - 1. The edges are labeled with a
 * positive weight.
 */
...
public class ListGraph implements Graph {
	...
	/**
	 * Create a directed graph with no edges and n vertices, labeled 0, 1, 2,
	 * ..., n - 1. Assume n is non-negative.
	 */
	...
	/**
	 * Adds the edge from u to v of the given weight to this graph. If the edge
	 * already exists, then its weight is replaced with the new weight.
	 */
	 ...
	 * TODO
	 * 
	 * Returns true if the graph is cyclic and false otherwise.
	 */
    ...
    Boolean isCyclicUtil(int v, Boolean visited[], int parent) {
        ...
        while (it.hasNext()) {
            i = it.next().to;
            System.out.println("i = " + i + " || v = " + v + " || parent = " + parent + " || visited = " + Arrays.toString(visited));

...
public class Majority {
	 ...
	 * compare A_1 and A_2. If they are equal, add one of these to B; otherwise
	 * do nothing. Then compare A_3 and A_4. Again if they are equal, add one of
	 * these to B; otherwise do nothing. Continue in this fashion until the
	 * entire array is read. If the length of A is odd, then add the last
	 * element to B. Then recursively find the one or two majority candidates
	 * for B; these will be candidates for A.
	 */
	...
	public static void main(String[] args) {
		...
		checkExpect(1, new int[] { 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 

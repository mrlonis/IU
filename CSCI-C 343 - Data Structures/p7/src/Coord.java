...
public class Coord implements Comparable<Coord> {
	...
	/**
	 * Returns true iff this Coord is visible on a board of the given
	 * dimensions.
	 */
	 ...
	 * @return A HashMap consisting of the neighbors for the given coordinate
	 *         with strings as keys representing the direction the neighbor lies
	...
	/**
	 * Returns the minimal distance separating this coord and the given coord.
	 * The result corresponds to the length of the shortest connecting wire.
	 * This is also known of as the Manhattan Distance between two points on a
	 * grid.
	 */

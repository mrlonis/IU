...
/**
 * This is a simple structure to encapsulate an obstacle on a chip. An obstacle
 * is a rectangle defined by its upper left corner and its lower right corner.
 * 
...
public class Obstacle {
	...
	/**
	 * Creates a new obstacle covering the rectangle with the given upper left
	 * corner and lower right corner on a grid.
	 */

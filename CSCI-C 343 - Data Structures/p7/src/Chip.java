...
public class Chip {
	 ...
	 * TODO
	 * 
	 * This method constructs a chip from a description in an input file. Most
	 * of this method is already written for you. You need to fill in the code
	 * to read the number of wires and the description of each wire from the
	 * file. You are also responsible for creating and populating the wires
	 * instance variable (which will be used by the layout() method to
	 * initialize the grid).
	 */
	...
	/**
	 * Returns true iff the cell at the specified coord is available for the
	 * wire.
	 */
	...
	/**
	 * Returns true iff the cell at the specified coord is in a region occupied
	 * by an obstacle.
	 */

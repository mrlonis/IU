...
#reader(lib "htdp-beginner-abbr-reader.ss" "lang")((modname |February 24nd Lecture Notes|) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
(require 2htdp/image)

(define handin "lecture-feb24")
(define team "yellow9")
...
; (at-rest? block landscape) returns #true iff block cannot

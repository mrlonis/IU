...
public class StageIF extends Stage {
  ...
  /**
   * This latch indicates to the IF stage if it should stall.
   * Only used by the simple scalar.
   */
  ...
  /**
   * Reading the instruction, modifying the PC.
   * Also branches if necessary, based on control.stageEXE.latControlTransfer
   * and control.stageEXE.latALUout
   */
  public void work () {
    print("PC=" + lngPC);

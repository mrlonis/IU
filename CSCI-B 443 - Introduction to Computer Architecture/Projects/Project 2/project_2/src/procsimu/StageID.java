...
public class StageID extends Stage {
  ...
  public void work () {
    ...
    case Const.MIPS_ARTH:
      ...
      print("Opx: " + lngOpx);
      switch ((int) lngOpx) {
      case Const.EXT_ADD: lngALUInstr = Const.ALU_ADD; break;
      case Const.EXT_SUB: lngALUInstr = Const.ALU_SUB; break;
      case Const.EXT_AND: lngALUInstr = Const.ALU_AND; break;
      case Const.EXT_OR:  lngALUInstr = Const.ALU_OR;  break;
      case Const.EXT_XOR: lngALUInstr = Const.ALU_XOR; break;
      case Const.EXT_SLT: lngALUInstr = Const.ALU_SLT; break;
      case Const.EXT_SLL:
      ...
      case Const.EXT_SRL:
        ...
        lngImm = Conversion.extractShAmt(lngInstr);
        break;
      default:            lngALUInstr = Const.ALU_NOP; break;
      }
    ...
    case Const.MIPS_XORI:
      ...
      // TODO Check for data hazards for register 2
      // if stall is needed, return early
   ...
   * @return       The new number for the register (eventually the forwarding code)
   *               or -1 if the stage should be stalled.
   */
  ...
  /**
   * A wrapping class to save the state of the stage in case of
   * a bubble.
   *
  ...
  private class StageIDState {
    ...
    /**
     * Convenience method to store the state.
     * Usage:
     * <PRE>
     *   stageState.store (lngInstr, lngPC, lngOp, lngNbReg1, lngNbReg2);
     * </PRE>
     */
    void store (long lngInstr, long lngPC, long lngOp,
                long lngNbReg1, long lngNbReg2) {

...
public class StageEXE extends Stage {
    ...
    /**
     * If the next IF stage should perform a control transfer rather than
     * incrementing the PC, this should be set to 1.
     */
    ...
    /**
     * The work method for EXE.
     * - Tests if there is a control transfer
     * - Execute (ARTH, MEM, or Control Transfer)
     */
    public void work() {
        long lngPC;
    ...
    /**
     * Manage forwarding.
     * Returns the value of the register after testing the
     * forwarding situation (ie the register number).
     * Superscalar implemented.
     *

/***************************************************************
 ...
 Description :   This class is exactly the same as StringTokenizer,
 except it provides a method for backing up a position.

 Date de creation     :  17/08/97
 Liste des modifications :
 Date            Auteur        Modifications
 --------------------------------------------
 17/08/97        SUN           Creation
...
/**
 * This class is exactly the same as StringTokenizer, except it provides
 * a method for backing up a position.  For example,
 * <p>
 * Example usage:
 * <PRE>
 ...
 * </PRE>
 * <p>
 * <P>This class was written to allow tokens to be shoved back into the
 * tokenizer.  It is exactly the same as java.util.StringTokenizer, but
 * See the documentation for java.util.StringTokenizer for more information
...
public class KSStringTokenizer implements Enumeration {
    ...
    /**
     * Constructs a KSStringTokenizer on the specified String, using the
    ...
    /**
     * Constructs a KStringTokenizer on the specified String, using the

...
public abstract class Stage extends Output implements WorkListener {
    ...
    /**
     * Method declaration.
     * Empty method, should be implemented by subclasses.
     */
    public void work() {
    }
    ...
    /**
     * Prints some text in the window.
     * Actually, the message is only printed when
     * <CODE> (level && Configuration.OUTPUT_LEVEL) != 0) </CODE>
     *

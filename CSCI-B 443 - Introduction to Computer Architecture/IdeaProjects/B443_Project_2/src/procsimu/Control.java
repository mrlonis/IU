...
import procsimu.util.ArgumentChecker;
...
public class Control extends JFrame implements Runnable, ActionListener {
    ...
    /**
     * Main method.
     * Some parameters can be passed to the program.
     * Use <CODE>java Control -help</CODE> to see how to use them.
     */
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        } else if (ac.equals("ipc")) {
            printIPC();
        } else if (ac.equals("infos")) {
            printInfos();
        }
    }
    ...
    private void processWork() {
        // TODO instead of executing work method of each stage like Project 1, execute all the work methods (see processClockChange)

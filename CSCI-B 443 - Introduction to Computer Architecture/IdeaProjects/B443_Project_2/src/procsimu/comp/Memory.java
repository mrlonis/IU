...
import procsimu.Stage;
import procsimu.Control;
import procsimu.Configuration;
...
public class Memory extends Stage {
    ...
    private void initWindow(String title) {
        ...
        scrollPane.setBackground(new Color(-3355444));
        ...
        table.setBackground(new Color(16777215));
    ...
    public void write(long address, long value) {
        ...
        dataModel.setValueAt(Long.valueOf(values[(int) address]), (int) address, 1);
        dataModel.setValueAt(Long.valueOf(values[(int) address + 1]), (int) address + 1, 1);
        dataModel.setValueAt(Long.valueOf(values[(int) address + 2]), (int) address + 2, 1);
        dataModel.setValueAt(Long.valueOf(values[(int) address + 3]), (int) address + 3, 1);
    ...
    public String getFileName() {
        ...
        return defDirectory + System.getProperty("file.separator") + defFile;
    }
    ...
    public void load(String filename) {
        ...
        for (int i = 0; i < values.length; i++) {
            intData[i][0] = Integer.valueOf(i);
            intData[i][1] = Integer.valueOf(values[i]);
        }

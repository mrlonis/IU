...
import procsimu.comp.ClockChangeListener;
import procsimu.comp.Const;


/**
 * This class stores the two last instruction executed and the
 * two last register number written.
 */
class LastInstructions implements ClockChangeListener {
     ...
     * They are updated at the next takt.
     *

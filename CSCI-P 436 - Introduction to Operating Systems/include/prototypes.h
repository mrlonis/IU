...
extern syscall future_shared_get(future*, int*);
extern syscall future_queue_get(future*, int*);
extern syscall future_get(future*, int*);

/* in file future_set.c */
extern syscall future_exclusive_set(future*, int);
extern syscall future_shared_set(future*, int);
extern syscall future_queue_set(future*, int);
extern syscall future_set(future*, int);

/* in file future_test.c */
extern uint32 future_test(int, char *[]);
extern uint32 future_ring(future *, future *);
extern uint future_prod(future *, int);
extern uint future_cons(future *);
...
/* in file myqueue.c */
extern queue * queue_alloc();
extern syscall queue_free(queue *);
extern syscall queue_pop(queue *, pid32 *);
extern syscall queue_push(queue *, pid32);

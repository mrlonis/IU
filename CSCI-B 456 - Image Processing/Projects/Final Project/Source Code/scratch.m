...
prob = histcounts(combined_vector, length(symbols))/length(combined_vector);
dict = huffmandict(symbols, prob);
enco = huffmanenco(combined_vector, dict);

compression_ratio = length(enco) / input_image_size;
...
decoded_vector = huffmandeco(enco, dict);
